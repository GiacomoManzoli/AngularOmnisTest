...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcOmnisCallbackObjectTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OmnisCallbackObject", function () {
      return OmnisCallbackObject;
    }); // TODO: define the Omnis Interface


    var OmnisCallbackObject = /*#__PURE__*/function () {
      function OmnisCallbackObject(jOmnisWrapper) {
        _classCallCheck(this, OmnisCallbackObject);

        this.jOmnisWrapper = jOmnisWrapper;
      }

      _createClass(OmnisCallbackObject, [{
        key: "omnisOnLoad",
        value: function omnisOnLoad() {
          console.info(" Omnis interface loaded. Waiting for the communication link...");
        }
      }, {
        key: "omnisOnWebSocketOpened",
        value: function omnisOnWebSocketOpened() {
          console.info(" web socket opened");
          this.jOmnisWrapper.sendEvent('ev_Ready');
        }
      }, {
        key: "omnisSetData",
        value: function omnisSetData(params) {
          console.log('omnisSetData', params);
        }
      }, {
        key: "omnisGetData",
        value: function omnisGetData(params) {
  ...
  /***/
  function srcOmnisWrapperTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "JOmnisWrapper", function () {
      return JOmnisWrapper;
    });
    /* harmony import */


    var _OmnisCallbackObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./OmnisCallbackObject */
    "./src/OmnisCallbackObject.ts");

    var JOmnisWrapper = /*#__PURE__*/function () {
      function JOmnisWrapper(jOmnis) {
        _classCallCheck(this, JOmnisWrapper);

        this.jOmnis = jOmnis; //

        var callbackObject = new _OmnisCallbackObject__WEBPACK_IMPORTED_MODULE_0__["OmnisCallbackObject"](this); // Set's the right callback object

        var swappableOmnis = jOmnis;
      ...
      _createClass(JOmnisWrapper, [{
        key: "sendEvent",
        value: function sendEvent(evName, evData, callId, omnisCallbackName) {
          console.info("[jOmnis] sendEvent ".concat(evName), evData);
          var message = {
            evType: evName,
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_OmnisWrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/OmnisWrapper */
    "./src/OmnisWrapper.ts");
    /* harmony import */
    ...
    console.warn('jOmnis?', jOmnis); // This isn't ideal: it saves the wrapper as a global variable
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_heroes_heroes_component__WEBPACK_IMPORTED_MODULE_2__["HeroesComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./heroes/heroes.component */
    "./src/app/heroes/heroes.component.ts"); // <-- NgModel lives here
  ...
  function srcAppHeroesHeroesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HeroesComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HeroesComponent_div_4_Template_input_ngModelChange_11_listener($event) {
    ...
    HeroesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 2,
      consts: [[1, "heroes"], [3, "selected", "click", 4, "ngFor", "ngForOf"], [4, "ngIf"], [3, "click"], [1, "badge"], ["placeholder", "name", 3, "ngModel", "ngModelChange"]],
  ...
  /***/
  function srcJOmnisHotSwapTs(module, exports) {
    var OmnisCallbackObjectDummy = /*#__PURE__*/function () {
      function OmnisCallbackObjectDummy() {
        _classCallCheck(this, OmnisCallbackObjectDummy);

        this.onLoadFired = false;
        this.onWebSocketOpenedFired = false;
      }

      _createClass(OmnisCallbackObjectDummy, [{
        key: "omnisOnLoad",
        value: function omnisOnLoad() {
      ...
      return OmnisCallbackObjectDummy;
    }();
    ...
    if (window['jOmnis']) {
      ...
      console.error('ERROR: jOmnis not defined'); //throw new Error('jOmnis non definito!');
    }
    /***/
  ...
  function srcMainTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _jOmnisHotSwap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./jOmnisHotSwap */
    "./src/jOmnisHotSwap.ts");
    /* harmony import */


    var _jOmnisHotSwap__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_jOmnisHotSwap__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */
    ...
    /*! @angular/platform-browser */
    "./node_modules/@angular/platform-browser/__ivy_ngcc__/fesm2015/platform-browser.js"); // Some paranoid code to avoid troubles with Omnis
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Applications/4K_dev817/Core/_htmlcontrols/ng-test/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
